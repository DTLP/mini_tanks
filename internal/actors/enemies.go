...
// ResetEnemyNamePool clears the per-level enemy name pool so the next
// getUniqueEnemyName call repopulates it from enemyNames. Call it on level
// advance and on game restart.
func ResetEnemyNamePool() {
    levelEnemyNames = nil
}